...
<?php
	...
	$BASE_URL	= 'http://localhost/simak/dosen';
	$JS_URL		= '';
	...
	$pageURL	= str_replace('/simak/dosen/','',$REQUEST_URI);
...
<html>
	...
	<div class="form-group body">
		<div class="form-inline">
			<div class="col-md-2 menu-content" style="padding:0px;">
				<?php include "menu.php"; ?>
			</div>
			<div class="col-md-10 page-content" style="padding:0px">
