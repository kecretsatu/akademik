...
<div class="panel panel-primary " >
  <div class="panel-heading">Input Absensi</div>
  <div class="panel-body" >
<div id="mahasiswa" style="font-size:12px;" >
	...
	<nav class="navbar navbar-default parameter" style="padding:10px; background:white;">
		...
		<div class="row parameter" style="border:0px solid black">
...
<style>
	.parameter label:not(.btn){width:90px !important;}
	.kehadiran{margin:0px !important; width:40px !important; padding:3px !important;font-size:11px !important;}
...
<script>
	...
	function get_absensi_control(n, v, val){
		...
		var ctl = '<label class="btn btn-default btn-sm kehadiran '+st+'" ><input '+ck+' type="radio" class="ctl_kehadiran" name="ctl_kehadiran_'+n+'" value="'+v+'" /> '+v+'</label>';
		//var ctl = '<label class="btn btn-default btn-sm kehadiran '+st+' "><input type="radio" class="input-sm" name="ctl_kehadiran_'+n+'" value="H" /> H</label> ';
		return ctl;
	}
